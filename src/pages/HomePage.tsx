              ...
              {user.openrouterApiKey ? (
                <div class="space-y-4">
                  ...
                  <p class="text-gray-600 text-sm">
                    Your OpenRouter API key is securely stored and ready to use.
                  </p>
                ...
                <div class="space-y-4">
                  ...
                  <p class="text-gray-600 text-sm">
                    Connect your OpenRouter account to access AI models for
        ...
        <div class="px-4 py-6 sm:px-0">
          <div class="text-center">
            ...
            <div class="space-x-4">
              ...
              <a
                href="/signin"
                class="border border-gray-300 hover:bg-gray-50 text-gray-700 px-8 py-3 rounded-md text-lg font-medium"
              >
                Sign In
              </a>
            </div>
